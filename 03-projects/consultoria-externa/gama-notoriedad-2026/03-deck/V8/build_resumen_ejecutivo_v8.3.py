"""
build_resumen_ejecutivo_v8.2.py  —  Vivienne V8.3  —  Resumen Ejecutivo (9 slides)
...
OUT_PATH  = BASE / "2026-05-18_Notoriedad-Gama-2026_V8.3_Resumen-Ejecutivo.pptx"
...
stripe = sl.shapes.add_shape(1, Inches(0), Inches(5.5), Inches(13.333), Inches(0.12))
stripe.fill.solid()
...
make_chart_c03(sl, C03, left=0.4, top=1.1, width=7.73, height=4.8)
...
make_chart_c08(sl, C08, left=0.4, top=1.1, width=8.0, height=5.5)
...
make_chart_c09(sl, C09, left=0.4, top=1.1, width=8.0, height=5.5)
...
# Fondo oscuro
bg_d = sl.shapes.add_shape(1, Inches(0), Inches(0), Inches(13.333), Inches(7.5))
bg_d.fill.solid()
