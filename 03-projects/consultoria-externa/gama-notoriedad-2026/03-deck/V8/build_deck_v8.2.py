"""
build_deck_v8.2.py  —  Vivienne V8.2  —  Deck principal (32 slides)
...
OUT_PATH  = BASE / "2026-05-18_Notoriedad-Gama-2026_V8.2.pptx"
...
stripe = sl.shapes.add_shape(1, Inches(0), Inches(5.2), Inches(10), Inches(0.12))
stripe.fill.solid()
...
make_chart_c01(sl, C01, left=0.4, top=1.05, width=9.2, height=5.8)
...
add_section_tag(sl, "[DATOS] S1")
make_chart_c02(sl, C02, left=0.4, top=1.05, width=9.2, height=5.7)
...
make_chart_c03(sl, C03, left=0.4, top=1.2, width=9.2, height=4.8)
bullet_box(sl, [
...
make_chart_c04(sl, C04, left=0.4, top=1.05, width=8.4, height=5.8)
...
add_section_tag(sl, "[DATOS] S2")
make_chart_c05(sl, C05, left=0.3, top=1.05, width=9.4, height=5.9)
...
make_chart_c06(sl, C06, left=0.4, top=1.05, width=9.2, height=5.8)
...
add_section_tag(sl, "[DATOS] S3")
make_chart_c07(sl, C07, left=0.3, top=1.05, width=9.4, height=5.9)
...
add_section_tag(sl, "[DATOS] S3")
make_chart_c08(sl, C08, left=0.4, top=1.05, width=9.2, height=5.7)
...
make_chart_c09(sl, C09, left=0.5, top=1.1, width=8.8, height=5.5)
...
make_chart_c10(sl, C10, left=0.4, top=1.1, width=6.5, height=4.8)
...
make_chart_c11(sl, C11, left=0.4, top=1.05, width=9.2, height=5.8)
...
make_chart_c12(sl, C12, left=0.5, top=1.1, width=8.8, height=5.5)
...
make_chart_c13(sl, C13, left=0.4, top=1.05, width=9.2, height=5.8)
...
add_section_tag(sl, "[DATOS] S7")
make_chart_c14(sl, C14, left=0.4, top=1.05, width=9.2, height=5.8)
...
bg_cta = sl.shapes.add_shape(1, Inches(0), Inches(0), Inches(10), Inches(7.5))
bg_cta.fill.solid()
