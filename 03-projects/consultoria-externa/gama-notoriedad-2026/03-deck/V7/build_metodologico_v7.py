"""Documento metodológico V7 — Notoriedad Gama 2026
...
OUTPUT = r"C:\rAUL\03-projects\consultoria-externa\gama-notoriedad-2026\03-deck\V7\2026-05-18_Notoriedad-Gama-2026_V7_Documento-Metodologico.docx"
...
def build_cierre(doc):
    add_h1(doc, "11. Para profundizar más")
    ...
    add_bullet(doc, "CU-1 a CU-9 — Análisis cuantitativos completos (Cuanti)")
    add_bullet(doc, "IN-1 a IN-8 — Análisis cualitativos completos (Sinta)")
    add_bullet(doc, "BR-2 V4 — Gate de claims publicables (Bruna, 2026-05-17)")
    add_para(doc, "")
    add_para(doc, "—  FIN DEL DOCUMENTO METODOLÓGICO V7  —",
...
def main():
    print("Iniciando documento metodologico V7...")
    doc = Document()
    ...
    print("  11. Cierre..."); build_cierre(doc)
