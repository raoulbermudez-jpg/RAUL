# =============================================================================
# backup_memory_to_onedrive.ps1
# Espejo incremental de la memoria persistente de Claude Code hacia OneDrive
# =============================================================================
# Fuente:  C:\Users\User\.claude\projects\C--Raul\memory
# Destino: C:\Users\User\OneDrive\RAUL-backup\claude-memory
...
# =============================================================================
# La memoria NO es un repo git por diseno del harness de Claude Code.
# Este backup provee recovery sin agregar control de versiones.
# =============================================================================

$source  = "C:\Users\User\.claude\projects\C--Raul\memory"
$dest    = "C:\Users\User\OneDrive\RAUL-backup\claude-memory"

# RAUL_ROOT con fallback a C:\RAUL para logs
if ($env:RAUL_ROOT) {
    $root = $env:RAUL_ROOT
} else {
    $root = "C:\RAUL"
...
$logFile = Join-Path $logDir "backup_memory.log"
...
Write-Log "=== Backup claude-memory -> OneDrive ==="
...
# Safety check 2: fuente debe tener un minimo de archivos (evita borrar OneDrive si memoria se vacia por error)
