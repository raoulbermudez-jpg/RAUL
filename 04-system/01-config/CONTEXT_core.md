...
Este sistema es el entorno de trabajo de Raul Bermúdez. Está diseñado como un **Personal Knowledge Assistant (PKA)** con principios **local-first**, **vendor-neutral** y estilo **LLM Wiki**.
