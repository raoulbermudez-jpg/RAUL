...
type: Technical
source: "11_Biblioteca_Tecnica_CONTROL-DE-VACIADO-DE-TANQUE-CON-RELE-DE-NIVEL-Y-PROTECCION-DE-VOLTAJE.pdf"
...
En el esquema mostrado a continuación, se presenta una aplicación
para el control y protección de voltaje de un sistema de vaciado de
...
dadas en función del líquido a transportar, el caudal de a manejar y
la distancia de traslado del líquido.
...
1. Mientras no se presente ninguna falla en el suministro eléctrico, la
salida S del protector de voltaje GSM-M220B se conecta con la
entrada F1, alimentando de esta forma al común (terminal 7) del
...
GRADO DE DIFICULTAD
LISTA DE EQUIPOS
PROTECTOR PARA MOTORES MONOFÁSICOS   GSM-MB
RELÉ DE NIVEL   GRN-MV
CONTROL PARA EVITAR FUNCIONAMIENTO EN VACÍO CON RELÉ
DE NIVEL Y PROTECCIÓN DE VOLTAJE
...
voltaje, bajo voltaje y apagones.
• Interruptor para encendido y
apagado manual.
...
voltaje, la salida S del protector de voltaje GSM-M220B se desconecta
de la entrada F1, por lo que no se alimenta el común del relé de nivel
GRN-MV, interrumpiendo la alimentación de la bobina del contactor.
...
control y protección de voltaje del sistema?
...
El funcionamiento de la aplicación con el programador horario es el
siguiente:
1. Mientras no se presente ninguna falla en el suministro eléctrico, la
salida S del protector de voltaje GSM-M220B se conecta con la
entrada F1, alimentando de esta forma al común (terminal 7) del
relé de nivel GRN-MV.
2. Si el nivel del tanque está por encima del electrodo de nivel bajo,
se activa la salida del relé, conectando los terminales 7 y 8.
...
Casos de falla:
1. Si se presenta alguna perturbación en el suministro eléctrico,
bajo o alto voltaje, la salida S del protector de voltaje
GSM-M220B se desconecta de la entrada F1, por lo que no se
alimenta el común del relé de nivel GRN-MV, interrumpiendo la
alimentación de la bobina del contactor, así haya algún evento
activo.
2. Si el nivel del tanque está por debajo del electrodo de nivel
bajo, se desactiva la salida del relé, desconectando los terminales
7 y 8 (lo que interrumpe la alimentación de la bobina del
contactor) y conectando los terminales 6 y 7 (encendido de la luz
piloto indicadora de tanque vacío).
