...
**Recommendation for Flat Surface Mounting:** Make two (2) holes (5/32") on panel surface before installing. See reference in General Dimensions section.
...
- Mounting hole spacing: 69 mm
- Terminal screw depth: 19 mm
...
GUCT provides LCD Display to indicate the output status (voltage, current, unbalance, frequency and load status). It also provides four (4) push buttons (On/Off, Up, Down and Select) for electrical parameter adjustment such as Voltage, Current, Frequency, Fault Detection Delay and others. Additionally, a Communication Port with MODBUS RTU protocol is included in GUCT.
...
a) Handling a flat screwdriver, pull downward the mounting bracket located at rear and lower side of GUCT.
