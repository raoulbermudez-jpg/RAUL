...
type: Technical
source: "Manual de Instalacion GUCT (In) 4"
product_line: "Genius"
...
Place GUCT at inclined position with its back side placed toward the upper edge of the DIN Rail and push down GUCT relay until it does CLICK on the rail.
...
**Recommendation for Flat Surface Mounting:** Make two (2) holes (5/32") on panel surface before installing. See reference the Guide for Flat Surface Mounting shown in point 5 (GUCT General Dimensions).

## 5 GUCT General Dimensions

Hole spacing: 69 mm (vertical) × 111 mm (horizontal)
Hole diameter: 5/32"
Device dimensions: 72 mm (width) × 92 mm (height) × 19 mm (depth)
...
**WARNING:** Disconnect power supply before dismounting GUCT.
