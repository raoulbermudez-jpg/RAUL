...
type: Technical
source: "Manual Instalacion GI+V2.E.pdf"
product_line: "Genius"
...
# Manual de Instalación GI+

## 1. GI+ Descripción General
...
**PRECAUCIÓN:** GI+ debe ser instalado en lugar accesible, libre de polvo, sucio, humedad y vibraciones. Que tenga suficiente espacio para la circulación de aire alrededor de su cubierta y fácil acceso a los controles de operación disponible. SOLO DE USO INTERIOR.
...
- **Ancho:** 124 mm
- **Profundidad:** 86 mm
- **Orificios de montaje en superficie plana:** 5/32" de diámetro, separados 85 mm
- **Tolerancia de corte para Flush Mounting:** +/- 2 mm
- **Dimensiones de corte para panel:** 64.5 mm x 210 mm (Tolerancia: +/- 2 mm)

## 7. GI+ Diagrama de Conexión
...
**Modelo:** GI+ MV-01-0017-B.02-S / GI+ MV-01-0017-B.012-S
