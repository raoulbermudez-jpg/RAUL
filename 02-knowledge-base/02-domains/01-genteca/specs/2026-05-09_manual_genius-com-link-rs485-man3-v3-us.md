...
type: Technical
source: "COM-LINK-RS485_MAN3_V3_US.pdf"
product_line: "Genius"
...
COM-Link RS485 is intended for the exchange of information between the MPA2 (Motor Performance Analyzer) and compatible master computers and computer terminals, which have monitoring software and user interface. The software must be provided by the client.

The COM-Link RS485 device is designed with components that provide isolation, allowing the interconnection of data with safety electrical conditions between equipment and users.
...
### 4.1 COM-PLUG Connectors Cables Dimensions
...
The COM-Link RS485 connects multiple MPA2 Relays (up to 32) to a computer through an RS-485/USB converter. The connection includes:

- Power supply (12V) provided by user
- Impedance termination (120 Ω, 1nF) at both ends of the communication bus
- COM-PLUG connectors with adapter COM-A-RS485
- Pin configuration:
...
| Max. number of units connected | 32 |
