---
title: "GSPT Installation Instructions Manual"
type: Technical
source: "GSPT_MAN_V3_US.pdf"
product_line: "Genius"
...
Make two (2) holes (5/32") on panel surface before installing. See as reference the Guide for Flat Surface Mounting shown in point 5 (GSPT General Dimensions).
...
- Circuit breaker/Fuses (5A, 600V options)
- GSPT relay with L1, L2, L3 voltage inputs
- Current sensing holes (I1, I2, I3) for three-phase motor connection
- Control contactor coil connection via 95-96 and 97-98 terminals
- Alarm light connection option via GIO Port
