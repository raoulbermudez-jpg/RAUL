...
type: Technical
source: "Manual de Instalacion GUCT (In) 3.pdf"
product_line: "Genius"
...
Make two (2) holes (5/32") on panel surface before installing. See the Guide for Flat Surface Mounting shown in point 5 (GUCT General Dimensions).
...
- Mounting hole spacing: 69 mm (horizontal), 19 mm (vertical reference)
...
The installation schematic includes:
- Circuit Breaker
- Contactor with coil
- Optional Fuses (5A, 600V)
- GUCT with three-phase inputs (L1, L2, L3) and motor connections (U, V, W for 3-phase motor M)
- GIO Port connection option
...
**Document Code:** MV-02-01070.E-01-NOM
```