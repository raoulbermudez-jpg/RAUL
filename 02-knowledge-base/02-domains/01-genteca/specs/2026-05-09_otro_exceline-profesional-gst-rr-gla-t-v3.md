```markdown
---
title: "GST-RR - Supervisor Trifásico para Refrigeración y Aire Acondicionado"
type: Technical
source: "GST-RR_GLA_T_V3.pdf"
...
Supervisor trifásico diseñado para garantizar confianza y duración en sistemas de refrigeración y aire acondicionado.
...
**Voltaje de operación:** 220 V~ / 440 V~

**Fase:** Trifásico (3)

**Normas de diseño:** IEC y COVENIN
...
⚠️ **ALERTA RIESGO DE CHOQUE ELÉCTRICO**
...
**Valores de confiabilidad, robustez y durabilidad.**
```