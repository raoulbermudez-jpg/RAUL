---
title: "Supervisor Trifásico GST-RM para Motores, Transferencias y Sistemas de Distribución"
type: Technical
source: "GST-RM_GLA_T_V2.pdf"
...
# Supervisor Trifásico GST-RM

## Descripción del Producto

Supervisor trifásico para motores, transferencias y sistemas de distribución. Diseñado bajo normas IEC y COVENIN con características de confiabilidad, robustez y durabilidad.

**Voltajes de operación:** 220 V~ / 440 V~

## Protecciones

El supervisor GST-RM proporciona protección por:
...
## Funciones del Supervisor GST-RM
...
**Perilla de TEMPORIZADO A LA DESCONEXIÓN:**
Ajuste el valor del temporizado a la desconexión que el supervisor deberá esperar ante una falla de bajo voltaje, alto voltaje, desbalance de voltaje o corrimiento de frecuencia.
...
Cuando el voltaje del suministro sea superior al máximo permitido, el indicador de ALTO VOLTAJE se encenderá fijamente y la carga a proteger permanecerá apagada.
...
- **Fecha:** 27/08/2024
- **Software de diseño:** Adobe Illustrator