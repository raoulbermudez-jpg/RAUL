...
type: Technical
source: "20240117_GCM-A250_HDE_V1_Rv14.pdf"
...
Los Breakers de caja moldeada ajustables GCM-A250 de Exceline Profesional son una familia de interruptores termomagnéticos que protegen contra sobrecargas y cortocircuitos. Ideales para uso comercial e industrial, también pueden ser utilizados como interruptores de seccionamiento (desconexión).
...
Los breakers de caja moldeada ajustables GCM-A250 son ideales para proteger tableros de distribución y control de motores y están disponibles en formato de 3 polos para voltajes de hasta 690 V~ y 250 V--.
...
- Ancho: 86 mm
- Profundidad: 75.2 mm
- Altura de montaje: 105 mm
- Profundidad de montaje: 110 mm
- Profundidad lateral: 70 mm
- Ancho lateral: 35 mm
- Altura lateral: 140 mm
- Profundidad lateral adicional: 125.5 mm

## Especificaciones Técnicas - 3 Polos

| Parámetro | Especificación |
|-----------|----------------|
| Voltaje máximo de funcionamiento | 690 V~ / 250 V--- |
| Corriente de cortocircuito (Icu=Ics) | 100 kA (220/240 V~) / 50 kA (380/415 V~) / 50 kA (440/460 V~) / 42 kA (480/500 V~) / 10 kA (660/690 V~) / 50 kA (250 V---) |
...
| Tiempo de actuación | De acuerdo a la curva del breaker (intensidad vs tiempo). Curva con disparo instantáneo (magnético) ajustable de 5 a 10 veces In con una tolerancia entre el 80 al 130% |
...
| Torque del tornillo | Entrada 6 N.m (53,1 Lb.in) / Salida 10 N.m (88,5 Lb.in) |
| Peso | 2 kg |
...
El breaker cuenta con:
- **Disparo Térmico:** Ir = (0.8 ~ 1) x In (ajustable)
- **Disparo Magnético:** Im = (5 ~ 10) x In con tiempo de actuación ≤ 10 ms

La curva característica muestra la relación entre corriente (I/Ir) y tiempo de operación en función del factor de sobrecarga.
