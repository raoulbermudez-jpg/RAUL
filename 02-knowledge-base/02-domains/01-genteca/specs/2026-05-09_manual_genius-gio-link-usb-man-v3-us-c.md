...
type: Technical
source: "GIO-LINK-USB_MAN_V3_US_c.pdf"
product_line: "Genius"
...
## 1. GIO-Link USB - General Description
...
The GIO-Link USB should be connected as shown below:
...
The GIO-Link USB adapters and connectors do not require any adjustment. For proper functioning, just adjust the software and/or the drivers on the terminal or computer using the following parameters:
...
R.I.F.: J-00223173-4
Av. El Buen Pastor, cruce con Calle Vargas, Edificio Alba, Piso 1, Local 1-A, Boleíta Norte, Caracas, 1070, República Bolivariana de Venezuela
